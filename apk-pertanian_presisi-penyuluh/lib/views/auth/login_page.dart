...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _handleLogin() async {
    ...
    if (result['success'] == true && result['data']?['user'] != null) {
      ...
      final session = UserSession(
        ...
        name: user['nama']?.toString() ?? 'Penyuluh Pertanian',
        role: 'penyuluh',
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Selamat bertugas, ${session.name}!'),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(result['message']?.toString() ?? 'Login gagal. Periksa akun Penyuluh Anda.'),
  ...
  Future<void> _useOfflineSession() async {
    await UserSessionService.saveSession(UserSessionService.defaultPenyuluhSession);
    if (mounted) {
      Navigator.of(context).pushReplacement(
        MaterialPageRoute(builder: (_) => const PenyuluhMainShell()),
      );
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Portal Verifikasi & Rekomendasi Pertanian Sumenep',
                  textAlign: TextAlign.center,
                  ...
                  child: Padding(
                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Login Petugas Penyuluh Lapangan',
                            style: AppTypography.headlineSm.copyWith(fontSize: 18),
                          ),
                          const SizedBox(height: 4),
                          Text(
                            'Gunakan Akun Dinas / Nomor WhatsApp Terdaftar',
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              labelText: 'Nomor WhatsApp / Email Penyuluh',
                ...
                Center(
                  child: TextButton.icon(
                    ...
                    label: const Text(
                      'Lanjut Mode Offline (Demo Penyuluh)',
