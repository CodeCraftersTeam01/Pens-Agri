...
import '../home/penyuluh_main_shell.dart';
...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> _handleRegister() async {
    ...
    if (result['success'] == true && result['data']?['user'] != null) {
      ...
      final session = UserSession(
        userId: user['id'] is int ? user['id'] : int.tryParse(user['id']?.toString() ?? '2') ?? 2,
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Pendaftaran Penyuluh berhasil! Ditugaskan di Desa ${_selectedDesa.desa}.',
            ),
            backgroundColor: AppColors.primary,
          ),
        );
        Navigator.of(context).pushAndRemoveUntil(
          MaterialPageRoute(builder: (_) => const PenyuluhMainShell()),
          (route) => false,
        );
      }
    } else {
  ...
  Future<void> _saveLocalAndProceed() async {
    final session = UserSession(
      ...
      name: _nameCtrl.text.trim().isNotEmpty ? _nameCtrl.text.trim() : 'Penyuluh Pertanian',
      role: 'penyuluh',
      desaId: _selectedDesa.id,
      desaName: _selectedDesa.desa,
      kecamatanName: _selectedDesa.kecamatan,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Pendaftaran Penyuluh'),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Aturan Ketat: 1 Desa = 1 Penyuluh',
                          ...
                          Text(
                            'Setiap desa di Kabupaten Sumenep dibina oleh tepat 1 petugas Penyuluh Pertanian Lapangan (PPL).',
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: 'Nama Lengkap & Gelar Penyuluh',
                            hintText: 'Contoh: Ir. Bambang Hermanto',
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: 'Nomor WhatsApp / Telepon Dinas',
                            hintText: '081298765432',
                        ...
                        TextFormField(
                          ...
                          maxLength: 16,
                          decoration: InputDecoration(
                            labelText: 'NIK / NIP Penyuluh (16 Digit)',
                          ...
                          validator: (v) {
                            if (v == null || v.trim().isEmpty) return 'NIK/NIP wajib diisi';
                            if (v.trim().length < 16) return 'NIK/NIP harus 16 digit';
                            return null;
                          },
                        ),
                        const SizedBox(height: 14),
                        ...
                        // Village Picker
                        Text(
                          'Pilih Desa Binaan di Kabupaten Sumenep:',
