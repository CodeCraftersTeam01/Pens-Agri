    ...
    try {
      ...
      if (!serviceEnabled) {
        return LocationResult.failure(
            "Harap aktifkan GPS / Layanan Lokasi di HP Anda.");
      }
      ...
      if (permission == LocationPermission.deniedForever) {
        return LocationResult.failure(
            "Izin lokasi ditolak permanen. Silakan aktifkan via Pengaturan HP.");
      }
      ...
      if (position != null) {
        ...
        return LocationResult.failure(
            "Gagal mendapatkan koordinat GPS. Coba lagi di tempat terbuka.");
      }
    } catch (e) {
      return LocationResult.failure(
          "Terjadi kesalahan saat membaca GPS: $e");
    }
  }
}
