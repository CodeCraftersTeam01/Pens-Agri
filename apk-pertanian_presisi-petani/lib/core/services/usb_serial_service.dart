...
class UsbSerialService {
  ...
  final ValueNotifier<UsbStatus> statusNotifier =
      ValueNotifier<UsbStatus>(UsbStatus.disconnected);
  final ValueNotifier<String> statusMessageNotifier =
      ValueNotifier<String>('Silakan Colok USB CH340 & Klik KONEK');
  final ValueNotifier<SoilTelemetry> telemetryNotifier =
      ValueNotifier<SoilTelemetry>(SoilTelemetry.empty());
  ...
  Future<SoilTelemetry?> readSensorData() async {
    ...
    try {
      ...
      final List<dynamic> rawData =
          await _platform.invokeMethod('sendModbusQuery');
