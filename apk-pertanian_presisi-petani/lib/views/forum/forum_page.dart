...
class _ForumPageState extends State<ForumPage> {
  ...
  Future<void> _loadFeed() async {
    ...
    final myStds = await ApiService.getMyStandards(1);
  ...
  void _openCreatePost() {
    CreatePostDialog.show(
      context,
      availableStandards: _myStandards,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text('Tulis Diskusi'),
      ),
      body: _isLoading
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Mulai obrolan pertama dengan membagikan pengalaman tanam atau standar tanah Anda.',
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // MANDATORY PROMINENT AMBER WARNING IF UNVERIFIED
          if (!isVerified) ...[
            const SizedBox(height: 6),
            Container(
